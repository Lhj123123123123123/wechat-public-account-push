...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxfd80ea58328b4c70',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '0540ac04e018fc60f6316e5bbd01208f',
   ...
   */
  USERS: [oGnUj597jU10S5VqnlpGwKP_VVbY',
    {
      // 想要发送的人的名字
      name: '老婆0',
      ...
      id: '',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'XV0CGvvOBi5Z7dprC9hV4Q-ZRs-n61vVHZJLAUMbf9M',
      // 所在省份
      province: '山西',
      // 所在城市
      city: '原平',
